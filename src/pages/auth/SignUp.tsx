...
import { Eye, EyeOff, UserPlus, ArrowLeft, CheckCircle, Check, WifiOff } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <Card className="border-0 shadow-elegant bg-background/95 backdrop-blur-sm">
            <CardHeader className="text-center pb-6">
              ...
              <CardTitle className="text-2xl text-foreground">Join Career na Mimi</CardTitle>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <Label htmlFor="newsletter" className="text-sm">
                      Send me career tips, updates, and success stories (optional)
                    </Label>
                  </div>
                </div>
          ...
          <div className="text-white space-y-8 animate-fade-in">
            <div>
              ...
              <p className="text-white/90 text-lg">
                Join thousands of Tanzanian youth who are already building successful careers 
