          ...
          <div className="p-6">
            <div className="space-y-8">
              <div className="bg-gradient-hero text-white rounded-lg p-8">
                ...
                <p className="text-white/90 text-lg">Managing the Career na Mimi platform</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-2xl font-bold text-foreground">42,156</div>
                ...
                <CardContent>
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground">
                      All administrative functions are ready for management and oversight.
                    </p>
                  </div>
                </CardContent>
              </Card>
