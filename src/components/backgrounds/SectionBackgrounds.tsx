...
export const HeroBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <svg
      className="absolute top-10 right-10 w-64 h-64 opacity-10 dark:opacity-25 animate-pulse-scale"
    ...
    <svg
      className="absolute bottom-20 left-10 w-72 h-72 opacity-10 dark:opacity-25"
      viewBox="0 0 200 200"
      xmlns="http://www.w3.org/2000/svg">
      {/* Network connections */}
    ...
    <svg className="absolute top-1/3 right-1/4 w-32 h-32 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '6s' }} viewBox="0 0 100 100">
    ...
    {/* Gradient Orbs */}
    <div className="absolute -top-48 -right-48 w-96 h-96 bg-[#FE047F]/10 dark:bg-[#FE047F]/20 rounded-full blur-3xl animate-pulse-scale" style={{ animationDuration: '10s' }}></div>
    <div className="absolute -bottom-48 -left-48 w-96 h-96 bg-[#00690D]/10 dark:bg-[#00690D]/20 rounded-full blur-3xl animate-pulse-scale" style={{ animationDuration: '12s', animationDelay: '2s' }}></div>
  </div>
);
...
export const StatsBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Animated Bar Charts */}
    <svg className="absolute top-10 right-20 w-48 h-48 opacity-5 dark:opacity-15" viewBox="0 0 200 200">
    ...
    {/* Pie Chart Segments */}
    <svg className="absolute bottom-20 left-10 w-40 h-40 opacity-5 dark:opacity-15 animate-spin" style={{ animationDuration: '30s' }} viewBox="0 0 100 100">
    ...
    {/* Data Points Network */}
    <svg className="absolute top-1/2 left-1/3 w-56 h-56 opacity-5 dark:opacity-15" viewBox="0 0 200 200">
      {[...Array(6)].map((_, i) => (
        <circle
          key={i}
...
export const JourneyBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Winding Path */}
    <svg className="absolute inset-0 w-full h-full opacity-[0.03] dark:opacity-[0.08]" viewBox="0 0 1000 800" preserveAspectRatio="none">
      <path
    ...
    {/* Milestone Markers */}
    <svg className="absolute top-20 left-20 w-24 h-24 opacity-10 dark:opacity-25 animate-float" style={{ animationDuration: '5s' }} viewBox="0 0 100 100">
    ...
    <svg className="absolute bottom-1/4 right-20 w-40 h-40 opacity-10 dark:opacity-20" viewBox="0 0 100 100">
    ...
    {/* Step Circles */}
    <svg className="absolute top-1/3 right-1/4 w-32 h-32 opacity-5 dark:opacity-15" viewBox="0 0 100 100">
...
export const FeaturesBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Gear/Cog Wheels */}
    <svg className="absolute top-10 left-10 w-32 h-32 opacity-5 dark:opacity-15 animate-spin" style={{ animationDuration: '15s' }} viewBox="0 0 100 100">
      <path
    ...
    <svg className="absolute bottom-20 right-10 w-40 h-40 opacity-5 dark:opacity-15 animate-spin" style={{ animationDuration: '20s', animationDirection: 'reverse' }} viewBox="0 0 100 100">
      <path
    ...
    <svg className="absolute top-1/3 right-1/4 w-20 h-32 opacity-10 dark:opacity-20" viewBox="0 0 50 100">
    ...
    {/* Atomic Orbits */}
    <svg className="absolute bottom-1/4 left-1/4 w-48 h-48 opacity-5 dark:opacity-15" viewBox="0 0 100 100">
...
export const TestimonialsBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Speech Bubbles */}
    <svg className="absolute top-20 left-10 w-32 h-32 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '6s' }} viewBox="0 0 100 100">
    ...
    <svg className="absolute bottom-1/4 right-20 w-28 h-28 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '7s', animationDelay: '1s' }} viewBox="0 0 100 100">
    ...
    {/* Star Ratings */}
    <svg className="absolute top-1/2 left-1/4 w-40 h-8 opacity-10 dark:opacity-20" viewBox="0 0 120 20">
    ...
    <svg className="absolute bottom-10 left-1/3 w-16 h-16 opacity-5 dark:opacity-15 animate-pulse" viewBox="0 0 100 100">
      <path
    ...
    <svg className="absolute top-1/3 right-10 w-24 h-24 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '8s' }} viewBox="0 0 100 100">
...
export const FAQBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Question Marks */}
    <svg className="absolute top-10 right-20 w-16 h-24 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '5s' }} viewBox="0 0 50 100">
    ...
    <svg className="absolute bottom-20 left-10 w-14 h-20 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '6s', animationDelay: '1s' }} viewBox="0 0 50 100">
    ...
    <svg className="absolute top-1/3 left-1/4 w-20 h-28 opacity-5 dark:opacity-15" viewBox="0 0 50 70">
    ...
    <svg className="absolute bottom-1/4 right-1/3 w-24 h-20 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '7s' }} viewBox="0 0 100 80">
...
export const PartnersBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Network Nodes */}
    <svg className="absolute inset-0 w-full h-full opacity-[0.03] dark:opacity-[0.08]" viewBox="0 0 1000 400">
      {/* Connection Lines */}
      <g stroke="#FE047F" strokeWidth="1" opacity="0.6">
    ...
    {/* Globe/World Icon */}
    <svg className="absolute bottom-10 right-20 w-28 h-28 opacity-5 dark:opacity-15 animate-spin" style={{ animationDuration: '30s' }} viewBox="0 0 100 100">
...
export const CTABackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <svg className="absolute top-10 right-1/4 w-24 h-40 opacity-5 dark:opacity-15" viewBox="0 0 50 100">
    ...
    <svg className="absolute bottom-20 left-1/4 w-28 h-44 opacity-5 dark:opacity-15" viewBox="0 0 50 100">
    ...
    {/* Rocket Launch */}
    <svg className="absolute top-1/3 left-10 w-20 h-32 opacity-5 dark:opacity-15 animate-float" style={{ animationDuration: '5s' }} viewBox="0 0 50 100">
    ...
    {/* Target/Goal Icon */}
    <svg className="absolute bottom-1/4 right-10 w-32 h-32 opacity-5 dark:opacity-15" viewBox="0 0 100 100">
    ...
    {/* Success Checkmarks */}
    <svg className="absolute top-20 right-10 w-16 h-16 opacity-10 dark:opacity-20" viewBox="0 0 50 50">
    ...
    <svg className="absolute top-1/2 right-1/3 w-24 h-24 opacity-5 dark:opacity-15 animate-spin" style={{ animationDuration: '20s' }} viewBox="0 0 100 100">
    ...
    {/* Gradient Orbs */}
    <div className="absolute -left-32 top-1/2 -translate-y-1/2 w-80 h-80 bg-[#FE047F]/15 dark:bg-[#FE047F]/25 rounded-full blur-3xl animate-pulse-scale" style={{ animationDuration: '8s' }}></div>
    <div className="absolute -right-32 top-1/2 -translate-y-1/2 w-80 h-80 bg-[#00690D]/15 dark:bg-[#00690D]/25 rounded-full blur-3xl animate-pulse-scale" style={{ animationDuration: '10s', animationDelay: '2s' }}></div>
  </div>
);
