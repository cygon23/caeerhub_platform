-- Safe Learning Modules Migration - Combines cleanup and creation
-- This migration safely handles existing tables

-- ============================================
-- PART 1: CLEANUP (Drop existing if any)
-- ============================================
...
-- Policies for user_learning_preferences
...
BEGIN
  ...
  -- Increment enrollments count only if this is a new enrollment
  UPDATE public.learning_modules
...
DO $$
BEGIN
    RAISE NOTICE '✅ Learning modules system created successfully!';
    RAISE NOTICE '📊 5 sample modules have been added';
