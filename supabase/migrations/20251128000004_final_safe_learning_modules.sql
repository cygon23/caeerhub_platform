-- Final Safe Learning Modules Migration
-- Handles all edge cases including non-existent tables

-- ============================================
-- PART 1: DROP TABLES (CASCADE will drop policies automatically)
-- ============================================
...
-- ============================================
-- PART 2: DROP FUNCTIONS (if they exist)
-- ============================================
...
SELECT
  ...
  '📊 Tables created: learning_modules, user_module_progress, user_learning_preferences' as tables,
  '🔒 Row Level Security enabled with 8 policies' as security,
  '⚡ 4 functions created: enroll_in_module, complete_module, increment_module_views, update_updated_at_column' as functions,
  '📚 5 sample modules inserted' as data;
